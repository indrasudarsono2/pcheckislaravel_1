			...
			<table>
				...
				<tr style="border: 0px; padding:0px">
					<td width="300px" align="center" style="border: 0px; padding:3px">
						<img src="data:image/svg;base64, {!! base64_encode(QrCode::format('png')->merge('/airnav.jpg')->size(100)->generate($score->form_rating->aplication_file->user->name.'-'.$score->form_rating->aplication_file->user->id))!!} "  class="kemenhub" alt="logo">
					</td>
				</tr>
				<tr>
