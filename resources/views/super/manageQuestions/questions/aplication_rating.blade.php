      ...
      <tbody>
        ...
        <tr>
          ...
          <td width="30px" align="center" scope="col">
            <a href="{{ route('aplication_ratings.question_groups.index', $aplication_rating) }}" class="btn btn-warning fas fa-tasks"> Manage Group</a>
            <a href="{{ route('aplication_ratings.mc_questions.index', $aplication_rating) }}" class="btn btn-info fas fa-tasks"> Manage Question</a>
          </td>
        </tr>
        @endforeach
      </tbody>
