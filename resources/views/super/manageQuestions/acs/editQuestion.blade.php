...
<h1>Edit ACS's Question</h1>    
@endsection

@section('section-title')
    Edit ACS's Question Form
@endsection
      ...
      <div class="card">
        <div card="card-body">
          <div class="table-responsive">
            <div class="card-body">
            <form method="post" action="/acs_questions/{{ $acs_question->id }}">
              @method('patch')  
              @csrf
