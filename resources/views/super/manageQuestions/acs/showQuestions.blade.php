...
@section('contain')
<a href="acs_questions/create" class="btn btn-primary fas fa-plus-square"> Add question</a>
<br>
<br>
  ...
  <div class="table-responsive">
    ...
    <div id="container">
      <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
          @foreach ($acs_question as $question)
          <tr>
            ...
            <td align="center">
              <a href="/acs_questions/{{ $question->id }}/edit" class="btn btn-success fas fa-edit"></a>
              <form action="/acs_questions/{{ $question->id }}" method="post" class="d-inline">
                @method('delete')
                @csrf
