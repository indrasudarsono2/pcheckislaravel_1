...
<div class="section-header-breadcrumb">
  <div class="breadcrumb-item active"><a href="{{ route('groups.group_member.show', [$group,$group_member]) }}">{{ $group_member->user->name }}</a></div>
</div> 
@endsection
  ...
  <div class="table-responsive">
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <form method="post" action="{{ route('groups.group_member.form_ratings.essay', [$group, $group_member, $form_rating]) }}">
          @csrf 
        <tr>
