   ...
   <body>
    ...
    <div class="table-responsive">
      <table>
        ...
        <tr>
          <td width="187px" colspan="2" align="left" valign="top"><font size="2px"><b>16e.</b> Nama OJTI<br/>@if ($aplication_file->control->confirm=="ya") @if($aplication_file->control->ojti == null)<font style="color:red">WRONG OJTI LICENSE NUMBER</font> @else{{ $aplication_file->control->ojti->name }} @endif @endif</font></td>
      ...
      @else
        <img src="{{ Storage::url($aplication_file->license->fileUrl) }}" alt="license" style="width: 100%; height:600px;">  
      @endif     
