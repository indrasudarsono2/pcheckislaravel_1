...
<div class="card">
  <div class="table-responsive">
    <div class="card-body">
      {{-- <form action="{{ route('sessionss.group_members.practical_examss.update', ['group_member'=>$group_member, 'practical_exam'=>$practical_exam]) }}" method="post"> --}}
      <form action="{{ route('sessionss.group_members.practical_examss.update', [$sessionss, $group_member, $practical_exam]) }}" method="post">
      @method('patch')
      @csrf
