      ...
      <div class="card-body">
        <form action="/med" method="post">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="date" name="medex_date" class="form-control  @error ('medex_date') is-invalid @enderror" value="{{ old('medex_date') }}" id="medex_date">
          ...
          <div class="form-group row" id="medexInput">
            ...
            <div class="col-sm-10">
              ...
              id="expiredMedex" name="medexExpired" value="{{ old('medexExpired') }}" readonly>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              name="examiner" value="{{ old('examiner') }}">
