...
<body>
		...
		<div align="center">
			...
			<table align="center">
					<tr>
						...
						<td>:</td>
						<td><font size="15px">{{ $score->form_rating->aplication_file->user->name }}</font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>:</td>
						<td><font size="15px">{{ $score->form_rating->aplication_file->user_id }}</font></td>
					</tr>
					<tr>
	...
	<div class="table-responsive">
		<div align="center">
			<table>
				<tr>
					<td width="300px" valign="top" align="center"><b>Checker</b></td>
					<td width="300px" valign="top" align="center"><b>Peserta</b></td>
				</tr>
				<tr style="border: 0px; padding:0px">
					<td width="300px" align="center" style="border: 0px; padding:3px">
						<img src="data:image/svg;base64, {!! base64_encode(QrCode::format('png')->merge('/airnav.jpg')->size(100)->generate($group_member->group->user->name.'-'.$group_member->group->user_id))!!} "  class="kemenhub" alt="logo">
					</td>
					<td width="300px" align="center" style="border: 0px; padding:3px">
						<img src="data:image/svg;base64, {!! base64_encode(QrCode::format('png')->merge('/airnav.jpg')->size(100)->generate($score->form_rating->aplication_file->user->name.'-'.$score->form_rating->aplication_file->user_id))!!} "  class="kemenhub" alt="logo">
					</td>
				</tr>
				<tr>
					<td width="300px" align="center">{{ $group_member->group->user->name }}</td>
					<td width="300px" align="center">{{ $score->form_rating->aplication_file->user->name }}</td>
				</tr>
			</table>
		</div>
	</div>
