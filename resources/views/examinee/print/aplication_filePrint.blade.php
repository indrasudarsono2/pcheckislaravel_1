...
<body>
		...
		<table style="border: 0px; margin:0cm">
			<tbody>
				<tr style="border: 0px; padding:2px">
					...
					<td style="border: 0px; padding:2px"><font size="15px">{{ Auth::user()->name }}</font></td>
				</tr>
				<tr style="border: 0px; padding:2px">
					<td style="border: 0px; padding:2px"><font size="15px">2. Nomor Lisensi</font></td>
					<td style="border: 0px; padding:2px">:</td>
					<td style="border: 0px; padding:2px"><font size="15px">{{ Auth::id() }}</font></td>
				</tr>
				<tr style="border: 0px; padding:2px">
	...
	<div class="container">
		<table>
			<tr>
				<th width="150px"><img src={{ asset('kemenhub.png') }} class="kemenhub" alt="logo"></th>
			...
			<tr>
				<td width="250px" colspan="2" align="left" valign="top"><font size="12px"><b>1.</b> Nama:<br/>{{ Auth::user()->name }}</font></td>
				<td width="150px" align="left" valign="top" colspan="2"><font size="12px"><b>2.</b> Nomor Lisensi<br/>{{ Auth::id() }}</font></td>
			...
			<tr>
				<td width="188px" colspan="2" rowspan="2" align="center" valign="botom"><font size="12px">................, {{ $now }}</font></td>
			...
			<tr style="border: 0px;">
				<td width="187px" colspan="3" align="center" valign="top" style="border:0px; padding:0px;">
					<font size="12px">{{ Auth::user()->name }}</font>
				</td>
			</tr>
		</table>
	</div>
