            ...
            <div class="card">
                <div class="card-header">
                  <p style="text-align: justify; text-justify:inter-word;">
                    Dear, {{$ielp->user->name}}<br><br>
                    Your IELP will be expired in the next {{\Carbon\Carbon::parse($ielp->expired)->diffInDays()}} days left.<br><br>
                    Please make sure that you are on queue for IELP test, or confirm to your Junior Manager for IELP schedule.<br><br>
                    @if ($ielp->level != 6)
                    Now it`s time for you to improve your english by practicing frequently, 
                    we belive that you are able to get your IELP score higher than before (level {{$ielp->level}}).<br><br>
                    @else
                    Now it`s time for you to maintain your english by practicing frequently.<br><br> 
                    @endif
