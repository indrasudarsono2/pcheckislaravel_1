        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="{{ asset('stisla/assets/img/airnav.jpg') }}" alt="logo" width="120" class="shadow-light rounded-circle">
            </div>
                ...
                <div class="card-body">
                  ...
                  <form method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input id="password-confirm" type="password" class="form-control @error ('conf_password') is-invalid @enderror" name="conf_password" tabindex="2" required="">
