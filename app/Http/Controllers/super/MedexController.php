...
class MedexController extends Controller
{
    public function index()
    {
        ...
        $count_medex =  count($medex2);
        $no = 1;
        return view('super.data.medex', compact('medex2', 'count', 'count_medex', 'no', 'three', 'six', 'nine'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $count_medex =  count($medex2);
        $no = 1;
        return view('super.ajax.findMedex', compact('medex2', 'count', 'count_medex', 'no', 'three', 'six', 'nine'));
    }
    ...
    public function print()
    {
        ...
        $pdf = PDF::loadview('super.print.medexTable', compact(
            'medex2',
            'count',
            'count_medex',
            'no',
        ...
        return $pdf->stream('printMedex-' . $now . '-.pdf');
    }
}
